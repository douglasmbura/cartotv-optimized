...
export const metadata: Metadata = {
  ...
  description:
    'Watch live TV channels from around the world with CartoTV. Stream news, sports, movies, kids and entertainment channels online by country — No sign-up required.',
  robots: {
    index: true,
    follow: true,
    googleBot: {
  ...
  verification: {
    other: { 'msvalidate.01': ['54877744799106B3304BF9074BD01A16'] },
  },
  applicationName: 'CartoTV',
  authors: [{ name: 'CartoTV' }],
  icons: {
    icon: '/favicon.png',
    apple: '/favicon.png',
  },
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    // lang/dir are set per-language in the [lang] layout below
