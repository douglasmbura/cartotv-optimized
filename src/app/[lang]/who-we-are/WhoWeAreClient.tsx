    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="glass-panel p-8 space-y-8">
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-foreground">{t('about.offer.title')}</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-xl font-semibold text-foreground">{t('about.team.title')}</h2>
            <div className="text-muted-foreground leading-relaxed space-y-4">
              ...
              <p>
                {t('about.team.contact').includes('hello@cartotv.com')
                  ? t('about.team.contact').split('hello@cartotv.com').map((part: string, i: number, arr: string[]) => (
                      <span key={i}>
                        {part}
                        {i < arr.length - 1 && (
                          <a href="mailto:hello@cartotv.com" className="text-primary hover:underline font-medium">
                            hello@cartotv.com
                          </a>
                        )}
                      </span>
