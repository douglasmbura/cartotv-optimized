  ...
  return (
    <div className="fixed right-4 bottom-56 z-40 flex flex-col gap-3">
      ...
      >
        ...
        <img src="/surfshark.png" alt="SurfShark" className="w-full h-full object-cover" />
      </a>
      <a
      ...
      >
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/vidiq.png" alt="VidIQ" className="w-full h-full object-cover" />
      </a>
      <a
      ...
      >
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/fliki.png" alt="Fliki" className="w-full h-full object-cover" />
      </a>
    </div>
  )
}
